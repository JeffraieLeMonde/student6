    ...
    public class InquiriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InquiryId,Question,Response,ContactId,UserId")] Inquiry inquiry)
        {
            if (ModelState.IsValid)
            {
                ...
                Entity crmInquiry = new Entity("jfn_inquiry");
                crmInquiry.Id = inquiry.InquiryId;
                crmInquiry["jfn_name"] = _userManager.GetUserName(User);
                crmInquiry["jfn_question"] = inquiry.Question;
                crmInquiry["jfn_contact"] = new EntityReference("contact",inquiry.ContactId);
                var service = CRM.CrmService.GetServiceProvider();
